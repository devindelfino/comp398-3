...
Updates: -added States.csv to databases and included it in the driver program. Made text more general. 
...
SOURCE CODE:
-LinkedList.py (source for my linked list)
-ListDriver.py (source for my driver program)
